                    ...
                    <div class="ps-xl-4 d-flex flex-column gap-lg-4 gap-3">
                        <div class="card-effect contact-office-item d-flex align-items-sm-center align-items-start wow fadeInUp"
                            ...
                            <div class="thumb w-100">
                                <img src="/template/assets/img/inner/contact-office1.jpg" alt="img" class="w-100">
                            </div>
                            <div class="content py-2 px-2">
                                <h4 class="text-black fw-semibold mb-1">Head Office</h4>
                                <p class="fs-16 mb-md-3 mb-2">4517 Washington Ave. Manchester, Kentucky 39495</p>
                                <a href="{{ route('contact') }}"
                                    class="text-black fs-18 fw-semibold text-decoration-underline d-block mb-1">
                                    View on map
                                </a>
                                <a href="javascript:void(0)"
                                    class="d-flex text-call fs-16 fw-500 align-items-center gap-1">
                                    <i class="fa-solid fa-phone"></i> +999 3265 464968
                                </a>
                            </div>
                        </div>
                        <div class="card-effect contact-office-item d-flex align-items-sm-center align-items-start wow fadeInUp"
                            data-wow-delay="0.5s">
                            <div class="thumb w-100">
                                <img src="/template/assets/img/inner/contact-office2.png" alt="img" class="w-100">
                            </div>
                            <div class="content py-2 px-2">
                                <h4 class="text-black fw-semibold mb-1">Local Office</h4>
                                <p class="fs-16 mb-md-3 mb-2">3891 Ranchview Dr. Richardson, California 62639</p>
                                <a href="{{ route('contact') }}"
                                    class="text-black fs-18 fw-semibold text-decoration-underline d-block mb-1">
                                    View on map
                                </a>
                        ...
                        <div class="card-effect contact-office-item d-flex align-items-sm-center align-items-start wow fadeInUp"
                            data-wow-delay="0.9s">
                            <div class="thumb w-100">
                                <img src="/template/assets/img/inner/contact-office3.png" alt="img" class="w-100">
                            </div>
                            <div class="content py-2 px-2">
                                <h4 class="text-black fw-semibold mb-1">Branch Office</h4>
                                <p class="fs-16 mb-md-3 mb-2">2118 Thornridge Cir. Syracuse, Connecticut 35624</p>
                                <a href="{{ route('contact') }}"
                                    class="text-black fs-18 fw-semibold text-decoration-underline d-block mb-1">
                                    View on map
                                </a>

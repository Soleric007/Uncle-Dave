    ...
    <section class="breadcrumb-section position-relative fix bg-cover"
        ...
        <div class="container">
            <div class="breadcrumb-content">
                <h2 class="white-clr fw-semibold text-center heading-font">
                    Error Page
                </h2>
            </div>
        </div>
                ...
                <div class="col-lg-6 d-center">
                    <div class="error-content text-center">
                        <div class="section-title text-center mb-3 text-lg-center">
                            <div class="thumb p-4 w-100">
                                <img src="/template/assets/img/logo/oops.png" alt="img" class="mb-4 oops-thumb w-100">
                            </div>
                            <h3 class="fw-semibold black-clr fs-32 mb-lg-3 mb-2 wow fadeInUp" data-wow-delay=".3s">
                                404 page Not Found
                            </h3>
                            <p class="fs-16 black-clr mb-4 pb-xxl-3">
                                During the execution of the database query, a timeout occurred. This issue arose because
                                the system exceeded the maximum
                                allowed response time for data retrieval, which is set at 30 seconds.
                            </p>
                            <a href="{{ route('index') }}" class="theme-btn fw-normal text-capitalize gap-1 px-6 rounded-3">
                                Previews Page
                            </a>
                        </div>
                    </div>
